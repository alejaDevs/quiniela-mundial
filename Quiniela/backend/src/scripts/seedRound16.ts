...
const QUARTER_FINAL_MATCHES: SeedMatch[] = [
  {
    ...
    stage: "quarter_final",
    groupLabel: null,
    kickoffDate: toDate("2026-07-09", "14:00"),
  ...
  },
  {
    ...
    stage: "quarter_final",
    groupLabel: null,
    kickoffDate: toDate("2026-07-10", "18:00"),
  ...
  },
  {
    ...
    stage: "quarter_final",
    groupLabel: null,
    kickoffDate: toDate("2026-07-11", "14:00"),
  ...
  },
  {
    ...
    stage: "quarter_final",
    groupLabel: null,
    kickoffDate: toDate("2026-07-11", "18:00"),
...
// ── Semifinales ──────────────────────────────────────────────────────────────
// SF1 (M101): Ganador M97 (Llave 1/2) vs Ganador M98 (Llave 5/6)
// SF2 (M102): Ganador M99 (Llave 3/4) vs Ganador M100 (Llave 7/8)
const SEMI_FINAL_MATCHES: SeedMatch[] = [
  {
    ...
    stage: "semi_final",
    groupLabel: null,
    kickoffDate: toDate("2026-07-14", "18:00"),
    stadium: "Estadio Dallas (AT&T Stadium)",
    city: "Arlington, Texas",
  },
  {
    ...
    stage: "semi_final",
    groupLabel: null,
    kickoffDate: toDate("2026-07-15", "18:00"),
    stadium: "Estadio Atlanta (Mercedes-Benz Stadium)",
    city: "Atlanta, Georgia",
  },
];
...
const FINAL_MATCHES: SeedMatch[] = [
  {
    ...
    stage: "final",
    groupLabel: null,
    kickoffDate: toDate("2026-07-19", "13:00"),
    stadium: "Estadio Nueva York Nueva Jersey (MetLife Stadium)",
    city: "East Rutherford, Nueva Jersey",
  },
];
